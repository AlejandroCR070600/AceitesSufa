...
<section class="container-fluid d-flex justify-content-center align-items-center" style="min-height: 100vh;">
  ...
  <div class="row w-100 justify-content-center  ">
    ...
    <div class="col-md-2 flex-column  bg-dark text-white m-2 p-3">
    <form method="GET" action="" class="form-group" style="width: 100%; max-width: 400px;">
        <div class="mb-3">
            <label for="buscar" class="form-label">Buscar por ID:</label>
            <input type="number" id="buscar" name="buscar" class="form-control" required>
        </div>

        <button type="submite"class="btn w-100 mb-3 text-white" style="background-color: #373E40;">Buscar</button>
    </form>

      <form method="POST" action="BD/agregar_datos.php" class="form-group" style="width: 100%; max-width: 400px;">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="Num_moto" class="form-label">Numero Moto</label>
            <input type="number" id="Num_moto" name="Num_Moto" class="form-control bg-light text-muted" required>
        </div>

        <div class="mb-3">
            <label for="Aceites" class="form-label">Aceites</label>
            <input type="number" id="Aceites" name="Aceites" class="form-control bg-light text-muted" required>
        </div>

        <div class="mb-3">
            <label for="Cant_Motos" class="form-label">Cantidad de motos</label>
            <input type="number" id="Cant_Motos" name="Cant_Motos" class="form-control bg-light text-muted" required>
        </div>

        <button type="submit" class="btn w-100 mt-3 text-white" style="background-color: #373E40;">AGREGAR</button>
    </form>

    </div>

    <!-- Columna para la tabla -->
    <div class="col-md-6 table-responsive p-0 m-2" style="max-height: 550px; overflow-y: auto;">
      <table class="table table-borderless table-hover m-0">
        <!-- Encabezado de la tabla con el color de fondo -->
        <thead class="bg-dark">
          <tr>
            <th>ID</th>
            <th>FECHA</th>
